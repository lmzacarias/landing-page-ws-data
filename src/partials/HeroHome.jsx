...
function HeroHome() {
  ...
  return (
    <section className="relative">
      ...
      <Modal
        title={<div>Contactanos a travez de whatsapp</div>}
      ...
      >
        <p>Selecciona los temas que requieres: </p>
        <br />
        <Checkbox>Tesis</Checkbox>
        <br />
        <br />

        <Checkbox>Analisis de datos</Checkbox>
        <br />
        <br />
        <Checkbox>Ciencia de datos</Checkbox>
        <br />
        <br />
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p
                ...
                data-aos-delay="150"
              >
                Empresa dedicada al desarrollo de soluciones analíticas y
                capacitaciones para maximizar el valor de tu empresa o negocio.
              </p>
              <div
